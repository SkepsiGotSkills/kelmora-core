...
# ------------------------------------------------------------------------------
# [MODULE 2] Deep System Scrub
# ------------------------------------------------------------------------------
step_scrub() {
    # Annihilate ghost files from previous script iterations
    ...
    # Nuclear regex scrub of bashrc to remove corrupted prompts
...
# ------------------------------------------------------------------------------
# [MODULE 3] Kernel & TCP Tuning (The Speed Hacks)
# ------------------------------------------------------------------------------
step_kernel_optim() {
    sudo tee -a /etc/sysctl.conf > /dev/null << 'EOF'
# --- Kelmora Cloud: Hyper-V Network & Memory Optimizations ---
...
EOF
    ...
    # Lift file descriptor limits for massive Minecraft/Docker servers
...
# ------------------------------------------------------------------------------
# [MODULE 7] Unified Command Engine (The Core)
# ------------------------------------------------------------------------------
step_cli_engine() {
...
# ------------------------------------------------------------------------------
# [MODULE 8] Dashboard & Boot Animation
# ------------------------------------------------------------------------------
step_motd() {
